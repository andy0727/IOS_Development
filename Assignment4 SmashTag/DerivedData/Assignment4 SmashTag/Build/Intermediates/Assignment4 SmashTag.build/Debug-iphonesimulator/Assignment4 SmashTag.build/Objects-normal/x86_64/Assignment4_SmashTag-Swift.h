...
SWIFT_CLASS("_TtC20Assignment4_SmashTag11AppDelegate")
...
SWIFT_CLASS("_TtC20Assignment4_SmashTag19ImageViewController")
...
@interface NSString (SWIFT_EXTENSION(Assignment4_SmashTag))
@end
...
SWIFT_CLASS("_TtC20Assignment4_SmashTag30TweetDetailTableViewController")
@interface TweetDetailTableViewController : UITableViewController
@property (nonatomic, copy) NSArray * __nonnull contents;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC20Assignment4_SmashTag22TweetKindTableViewCell")
@interface TweetKindTableViewCell : UITableViewCell
- (void)updateUI;
...
SWIFT_CLASS("_TtC20Assignment4_SmashTag18TweetTableViewCell")
@interface TweetTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * __null_unspecified TweetImageView;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified TweetScreenName;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified TweetTextLabel;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified tweetCreatedLabel;
- (void)updateUI;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * __nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC20Assignment4_SmashTag24TweetTableViewController")
@interface TweetTableViewController : UITableViewController <UITextFieldDelegate>
@property (nonatomic, copy) NSArray * __nonnull Tweets;
@property (nonatomic, copy) NSString * __nullable searchText;
- (void)viewDidLoad;
- (void)refresh;
- (IBAction)refreshControl:(UIRefreshControl * __nullable)sender;
@property (nonatomic, weak) IBOutlet UITextField * __null_unspecified searchTextField;
